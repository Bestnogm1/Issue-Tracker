...
function DashBoard({allTickets, handleDeleteTicket, completed, handleGetAllLobby}) {
    ...
    <>
      ...
      <Chakra.Tabs w='100%'>
        <Chakra.TabList w='100%'>
          ...
          <Chakra.Tab onClick={() => handleDeleteTicket(handleGetAllLobby())} > completed tickets 
          </Chakra.Tab>
          <SearchCompt
            search={search}
            setSearch={setSearch}
